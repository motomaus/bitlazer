      ...
      <div className="flex flex-col gap-6 md:gap-[2.375rem] md:p-10 px-4 py-6 ">
        ...
        <div className="flex flex-col gap-[2.375rem]">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="tracking-[-0.06em] leading-[1.313rem] max-w-[29.5rem]">
              <p className="m-0">
                / Implement a native BTC bridge using a light client with Stylus smart contracts on
                Arbitrum.
              </p>
              <p className="m-0">
                / Facilitate seamless transfers and interactions with native BTC within the Bitlazer
                ecosystem.
              </p>
            </div>
          </div>
          <div className="flex flex-col gap-4">
            ...
            <div className="tracking-[-0.06em] leading-[1.313rem] max-w-[29.5rem]">
              ...
              <p className="m-0">
                / Enable native sequencing of L3 roll-up payloads and withdrawals, ensuring secure
                handling of native BTC requests.
              </p>
            </div>
          </div>
        </div>
