            ...
            <div className="flex flex-col gap-[2.375rem]">
              <div className="flex flex-col gap-4">
                ...
                <div className="tracking-[-0.06em] leading-[1.313rem] font-maison-neue-trial">
                  Users can bridge their Wrapped Bitcoin (WBTC) from Ethereum to Bitlazer's Layer 3
                  (L3) network, or directly deposit native Bitcoin (BTC) using the BTC-native
                  bridge, powered by light client technology. This process securely transfers assets
                  to the L3 Bitlazer network, where they can participate in decentralized
                  applications (dApps).
                </div>
              </div>
              <div className="flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-4">
                ...
                <div className="tracking-[-0.06em] leading-[1.313rem] font-maison-neue-trial">
                  <p className="m-0">
                    Users who bridge their BTC and actively participate in staking can also qualify
                    for the airdrop of LZR tokens. Early bridgers receive an additional 20% bonus
                    from the total LZR supply allocated for the airdrop, incentivizing active
                    engagement and early adoption of the Bitlazer ecosystem.
                  </p>
                  <p className="m-0">
                    These steps ensure that users not only receive staking rewards but also benefit
                    from the LZR airdrop, maximizing their participation in the Bitlazer network’s
                    growth.
                  </p>
                </div>
              </div>
